  ...
  return (
    <>
      <header className="relative mb-3 flex items-center justify-between overflow-hidden py-4">
        ...
        <button
          className="relative right-2 top-0 z-50 p-2 md:hidden"
        ...
        {/* Overlay */}
        <div
          className={`fixed inset-0 bg-gray-500 bg-opacity-50 transition-opacity duration-[250ms] ${menuOpen ? "pointer-events-auto opacity-100" : "pointer-events-none opacity-0"} md:bg-opacity-0`}
        ...
        >
          <ul className="mt-20 list-none p-4 md:m-0 md:flex md:flex-row md:flex-wrap md:justify-end md:p-0">
            <li>
              <a href="#">Home</a>
            </li>
            <li>
